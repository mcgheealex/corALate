function [Imgout] = Imageoverlay_withcolorbar2(BG, OL, Mask, alpha, PlotTitle, scaleBar , colorScale)
    ...
    text(Ty/2,toppadding/2,PlotTitle,'FontSize',14,'FontWeight',"bold",'HorizontalAlignment','center')

    % add scalebar text
    text(sLy+sL/2,sLx - 4*st,[num2str(round(scaleBar{2}*scaleBar{4})) ' ' scaleBar{3}],'FontSize',14,'Color','black','HorizontalAlignment',"center")
