function app = Start_SERIAL2D(app)
     % Step 0 initiate
            ...
            obj.BeadPara.winSize = [app.maxwinsizeEditField_1_SERIAL.Value, app.maxwinsizeEditField_1_SERIAL.Value];      % By default
    ...
    for ImgSeqNum = 2 : obj.NumberOfImages
        ...
        % Step 3 Deconvolute using a PSF
         ...
         % Step 4 If beads are black then adjust the image 
